...
PAIRWISE_INFERENCE_PATH =  PREPROCESSED_PATH / "pairwise_probability"
NETWORKS_INFO_PATH = PREPROCESSED_PATH / "network_info"
NETWORKS_PATH = PREPROCESSED_PATH / "networks" 
